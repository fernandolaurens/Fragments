package com.laurens.mygooglemaps
...
import com.laurens.mygooglemaps.databinding.ActivityMapsBinding
        ...
        mMap.setOnMapLongClickListener { latLng ->
            mMap.addMarker(
                MarkerOptions()
                    ...
                    .icon(vectorToBitmap(R.drawable.android, Color.parseColor("#3DDC84")))
            )
        }
